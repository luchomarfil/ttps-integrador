...
Client.create!(cuil_cuit:"20305759482",dni:30575948,name:"Luciano",surname:"Marfil",gender_id:1,birth_date:"2010-01-01")
Client.create!(cuil_cuit:"20307812542",dni:30781254,name:"Carlos",surname:"Sánchez",gender_id:1,birth_date:"1980-01-01")
Client.create!(cuil_cuit:"20182321542",dni:18232154,name:"Edmon",surname:"Sabiondo",gender_id:1,birth_date:"1970-01-01")
Client.create!(cuil_cuit:"20256589542",dni:25658954,name:"Peppa",surname:"Pig",     gender_id:3,birth_date:"1955-01-01")
